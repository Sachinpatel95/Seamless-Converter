...
def TemperatureConverter():
    ...
    celEntry.grid(row = 2, column = 1, pady = 57, sticky = NW, padx = 215 )

    fahEntry = Entry (top, width = 10, bd = 3, textvariable = fahTempVar)
    fahEntry.grid(row = 2, column = 1, pady = 107, sticky = NW, padx = 257 )
...
widget = Button(root, text="QUIT", bg="white", fg="orange",font = ("arial", 15,"bold"),relief = RAISED, overrelief = GROOVE, bd=2, justify = CENTER, command=root.destroy).place(x=350,y=350)
root.mainloop()
